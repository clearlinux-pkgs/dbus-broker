...
Source0  : https://github.com/bus1/dbus-broker/releases/download/v26/dbus-broker-26.tar.xz
...
%prep
%setup -q -n dbus-broker-26
cd %{_builddir}/dbus-broker-26
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611154868
...
cp %{_builddir}/dbus-broker-26/LICENSE %{buildroot}/usr/share/package-licenses/dbus-broker/94c6ae483469d0109b64bb6ad7f33af3fa42435d
