...
Source0  : https://github.com/bus1/dbus-broker/releases/download/v28/dbus-broker-28.tar.xz
...
%prep
%setup -q -n dbus-broker-28
cd %{_builddir}/dbus-broker-28
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616081815
...
cp %{_builddir}/dbus-broker-28/LICENSE %{buildroot}/usr/share/package-licenses/dbus-broker/94c6ae483469d0109b64bb6ad7f33af3fa42435d
