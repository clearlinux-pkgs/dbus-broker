...
Version  : 25
Release  : 10
URL      : https://github.com/bus1/dbus-broker/releases/download/v25/dbus-broker-25.tar.xz
Source0  : https://github.com/bus1/dbus-broker/releases/download/v25/dbus-broker-25.tar.xz
...
%prep
%setup -q -n dbus-broker-25
cd %{_builddir}/dbus-broker-25
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607010042
...
cp %{_builddir}/dbus-broker-25/LICENSE %{buildroot}/usr/share/package-licenses/dbus-broker/94c6ae483469d0109b64bb6ad7f33af3fa42435d
